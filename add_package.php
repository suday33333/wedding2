...
<body>
    ...
    <div class="d-flex justify-content-center">
        ...
        <div class= "h5 text-center alert alert-primary mb-4 mt-4 " role="alert"> เพิ่มข้อมูลแพ็กเกจ </div>
    ...
    <input type="text" name="detail"  class="form-control" placeholder="รายละเอียดแพ็กเกจ" required > <br>
